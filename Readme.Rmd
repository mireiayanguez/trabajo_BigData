...
La versión final del trabajo puede visualizarse en: <https://mireiayanguez.github.io/trabajo_BigData/>. 
...
El título del trabajo es Análisis Económico Austríaco En el trabajo hago un análisis económico de Austria observando las variables más importantes para conocer la calidad del país y por otra parte un análisis más turístico y de calidad de vida para poder comprobar si Austria es o no un buen país para vivir. 
